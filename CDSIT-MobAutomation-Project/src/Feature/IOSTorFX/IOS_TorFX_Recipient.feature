...
Feature: Recipient Functionality :
  ...
  @TorFX_CD_PID-3605_TC170 @TorFX_Sanity @TorRecipientlot1
  ...
  @TorFX_PID-3610_TC144 @TorFX_Regression(1) @TorRecipientlot1
  ...
  @TorFX_PID-3610_TC145 @TorFX_Sanity @TorRecipientlot1
  ...
  @TorFX_PID-3607_TC0150 @TorFX_Regression(1) @TorRecipientlot2
  ...
  @TorFX_PID-3605_TC1651 @TorRecipientlot3
  ...
  @TorFX_PID-3605_TC1732 @TorRecipientlot3
  ...
  @TorFX_PID-3605_TC171 @TorRecipientlot5
  ...
  @TorFX_PID-3609_TC188 @TorRecipientlot5
  ...
  #addressField :Addressline1,City,PostCode
  #bankField:AccountNumber,ABA,IBAN,SWIFT,SORT,IFSC,BSB,Transit
  @TorFX_PID-3609_TC189 @TorRecipientlot5
  ...
  @TorFX_PID-3609_TC190 @TorRecipientlot5
