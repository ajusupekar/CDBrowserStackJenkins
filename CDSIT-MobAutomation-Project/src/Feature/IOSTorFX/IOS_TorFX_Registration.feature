...
Feature: To test the registration functionality
  ...
  @TorFX_PID-3854_TC07 @Regression(1) @TorRegLot1
  ...
  @TorFX_PID-3854_TC09 @TorFX_Regression(1) @TorRegLot1
  ...
  @TorFX_PID-3854_TC15 @TorFX_Regression(1) @TorRegLot1
  ...
  @TorFX_PID-3858_42 @Regression(1) @TorRegLot4
  ...
  @TorFX_PID-3858_43 @Regression(1) @TorRegLot4
  ...
  @TorFX_PID-3856_61 @TorFX_Regression(1) @TorRegLot5
  ...
  @TorFX_PID-3859_4 @TorFX_Sanity @TorRegLot5
  Scenario Outline: 7.14 To verify that user land on kyc screen
    ...
    Examples: 
      | FirstName | LastName | EmailID                   | DateOfBirth | country        | occupation | otherOccupation | address | countryCode | mobileNumber | environment | password  |
      | jhgbhj876 | jhj87    | dbcfhj967@dispostable.com | 11-03-1987  | United Kingdom | Director   | NA              |   33500 | +91         |   8149461195 | UAT         | Welcome12 |
