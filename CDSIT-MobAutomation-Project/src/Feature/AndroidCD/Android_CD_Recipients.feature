...
Feature: Recipient :
  ...
  @PAD-2928_TC124 @EditRecipient @regression
  ...
  Scenario Outline: 7.1, 7.5 To verify that user is able to edit recipient sucessfully when  bank and pernal details updated
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Seina Brown   | AUD      |         56986 | FirstName-Seina,LastName-Brown,AccountNo-56986,Sortcode-111111 | UAT         | 
  ...
  Scenario Outline: 7.1, 7.5 To verify that user is able to edit recipient sucessfully when bank and pernal details updated
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Usd Recipient | USD      | 1235588888877777 | FirstName-Usd,LastName-Recipient,AccountNo-1235588888877777,BSBcode-121100782 | 
  ...
  Scenario Outline: 7.6 To verify recipient type should be editabled and user is able to save the recipient when Type changed Company to Individual
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Sam Walness   | USD      |      22345678 | Sam Walness       | 
  ...
  Scenario Outline: 7.13 7.14,7.15  To verify when all data,bank details are changed with valid data and recipient should be saved successfully and user lands on recipient  list page  with updated list
    ...
    Examples: 
      | emailAddress | password       | Type    | recipientName | currency | accountNumber | fieldname-data                     | 
      | CDRegEmailId | CDRegEmailPass | Company | Gbp Recipient | GBP      |      12345678 | AccountNo-12345678,Sortcode-111111 | 

  @PAD-2925_TC166 @addRecipent @smokeTest @sanity @regression
  Scenario Outline: 3.17,3.18 To verify recipient should be add successfully though swift code and newly added recipient should be mapped correctly on recipient view screen.
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Sam Walness   | United States of America-USD |      22345678 | 122235821 | 
  ...
  Scenario Outline: 7.16 To verify the recipient is edited successfully when it is used in trade
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Sam Walness   | USD      |      22345678 | AccountNo-22345678,ABANo-122235821 | ValidOTP | FirstName-Sam,LastName-Walness | AdressLine1-1992 Cork St,City-Guelph,Postcode-14025 | 

  @PAD-2928_TC149 @deleteRecipient @sanity @regression
  ...
  Scenario Outline: 7.16 verify application fetch the bank details for valid bank SORT,BSB,TranUAT Number,ABA or IFSC code on edit recipient screen
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Seina Brown   | AUD      |         56986 | AccountNo-56986,SortCode-111111 | ValidOTP | 
  ...
  Scenario Outline: 7.16   To verify that user is able to update recipient data with regex provided in the Global NFR document into text field and shows success icon.
   ...
   Then android the app should load the onboarding screen
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Ana Martin    | USD      |      44556671 | AccountNo-44556671,ABANo-122101706 | ValidOTP | FirstName-Ana,LastName-Martin | AdressLine1-Estreet!@$%^&*()_+?><:./,City-California!@,Postcode-0000002 | UAT         | 
  ...
  Scenario Outline: 7.6 To verify the error message to be displayed on wrong OTP attempts while editing recipint.
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Seina Brown   | AUD      |      56111986 | AndroidInvlaidOTP | AccountNo-56986,Sortcode-111111 | 
  ...
  Scenario Outline: 7.6  To verify reset OTP flow user shoudld be able to edit the recipient
    ...
    Examples: 
      | emailAddress | password       | Type     | recipientName | currency | accountNumber | otp               | fieldname-data                     | 
      | CDRegEmailId | CDRegEmailPass | Commpany | Gbp Recipient | AUD      |      12345678 | AndroidInvlaidOTP | AccountNo-12345678,Sortcode-111111 | 
  ...
  Scenario Outline: 7.6  To verify that application do not get crash and user lands on invalid OTP screen when user switches between two application
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Seina Brown   | AUD      |         56986 | AndroidInvlaidOTP | FirstName-Seina,LastName-Brown,AccountNo-56986,Sortcode-111111 | com.google.android.apps.maps | 
  ...
  Scenario Outline: 7.16 To verify the recipient adress should get edited and thoses are edited
    ...
    Examples: 
      | emailAddress | password       | Type       | recipientName | currency | accountNumber | fieldname-data                                | 
      | CDRegEmailId | CDRegEmailPass | Individual | Seina Brown   | AUD      |         56986 | AdressLine1-abcd xyz,City-pune,Postcode-12345 |  
  ...
  Scenario Outline: 7.13 7.14,7.15 To check recipient gets edited successfully with max data
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | John Morgan   | CAD      |    2233556677 | john morgan       | AdressLine1-11111111111111,City-11111111111,Postcode-22222222222 |  
  ...
  Scenario Outline: 3.16 To verify invalid OTP error message on add recipient otp screen
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | Sam William   | United Kingdom-GBP |      12345678 |    111111 | AndroidInvlaidOTP | 
  ...
  Scenario Outline: 3.17,3.18 To verify recipient should be add successfully and newly added recipient should be mapped correctly on recipient view screen.
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | shorn Walness | United Kingdom-EUR | GB29NWBK60161331926819 | 
  ...
  Scenario Outline: 3.7,3.8,3.9 To verify error message while adding duplicate payee
    ...
    Examples: 
      | emailAddress | password       | Type       | recipientName | country-currency | accountNumber      | 
      | CDRegEmailId | CDRegEmailPass | Individual | Adam Kelvin   | Finland-EUR      | FI2112345600000785 | 
  ...
  Scenario Outline: To verify application fetches bank details for valid SWIFT code on edit recipient screen
    ...
    Examples: 
      ...
      | CDRegEmailId | CDRegEmailPass | Individual | sam Walness   | United States of America-USD |      22345678 | USBKUS44LAX | UAT         | USD      | AccountNo-44556671,ABANo-122101706 | ValidOTP | FirstName-Ana,LastName-Johnson | AdressLine1-E steet,City-Helsinki,Postcode-00002 | 
