...
Feature: Recipient :
  ...
  @PAD-2928_TC124_AndroidTorFxMob 
  ...
  Scenario Outline: 7.1, 7.5 To verify that user is able to edit recipient sucessfully when  bank and pernal details updated
    ...
    Examples: 
      | emailAddress | password       | Type       | recipientName | currency | accountNumber | fieldname-data                                                 | environment | 
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Seina Brown   | AUD      |         56986 | FirstName-Seina,LastName-Brown,AccountNo-56986,Sortcode-111111 | UAT         | 
  ...
  Scenario Outline: 7.6 To verify recipient type should be editabled and user is able to save the recipient when Type changed Company to Individual
    ...
    Examples: 
      | emailAddress | password       | Type       | recipientName | currency | accountNumber | firstnamelastname |  
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam Walness   | USD      |      22345678 | Sam Walness       | 
  ...
  Scenario Outline: 7.13 7.14,7.15  To verify when all data,bank details are changed with valid data and recipient should be saved successfully and user lands on recipient  list page  with updated list
    ...
    Examples: 
      | emailAddress | password       | Type    | recipientName | currency | accountNumber | fieldname-data                     | 
      | TorFxRegEmailId | TorFxRegEmailPass | Company | Gbp Recipient | GBP      |      12345678 | AccountNo-12345678,Sortcode-111111 | 

  @PAD-2925_TC1661_AndroidTorFxMob @TorFxSanity
  Scenario Outline: 3.17,3.18 To verify recipient should be add successfully though swift code and newly added recipient should be mapped correctly on recipient view screen.
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam Walness   | United States of America-USD |      22345678 | 122235821 | 
  ...
  Scenario Outline: 7.16 To verify the recipient is edited successfully when it is used in trade
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam Walness   | USD      |      22345678 | AccountNo-22345678,ABANo-122235821 | ValidOTP | FirstName-Sam,LastName-Walness | AdressLine1-1992 Cork St,City-Guelph,Postcode-14025 | 

  @PAD-2928_TC149_AndroidTorFxMob @TorFxSanity
  ...
  Scenario Outline: 7.6 To verify the error message to be displayed on wrong OTP attempts while editing recipint.
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Seina Brown   | AUD      |      56111986 | AndroidInvlaidOTP | AccountNo-56986,Sortcode-111111 | 
  ...
  Scenario Outline: 7.6  To verify reset OTP flow user shoudld be able to edit the recipient
    ...
    Examples: 
      | emailAddress | password       | Type     | recipientName | currency | accountNumber | otp               | fieldname-data                     | 
      | TorFxRegEmailId | TorFxRegEmailPass | Commpany | Gbp Recipient | AUD      |      12345678 | AndroidInvlaidOTP | AccountNo-12345678,Sortcode-111111 | 
  ...
  Scenario Outline: 7.6  To verify that application do not get crash and user lands on invalid OTP screen when user switches between two application
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Seina Brown   | AUD      |         56986 | AndroidInvlaidOTP | FirstName-Seina,LastName-Brown,AccountNo-56986,Sortcode-111111 | com.google.android.apps.maps | 
  ...
  Scenario Outline: 7.16 To verify the recipient adress should get edited and thoses are edited
    ...
    Examples: 
      | emailAddress | password       | Type       | recipientName | currency | accountNumber | fieldname-data                                | 
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Seina Brown   | AUD      |         56986 | AdressLine1-abTorFx xyz,City-pune,Postcode-12345 |  
  ...
  Scenario Outline: 7.13 7.14,7.15 To check recipient gets edited successfully with max data
    ...
    Examples: 
      | emailAddress | password       | Type       | recipientName | currency | accountNumber | firstnamelastname | fieldname-data                                                   |  
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | John Morgan   | CAD      |    2233556677 | john morgan       | AdressLine1-11111111111111,City-11111111111,Postcode-22222222222 |  
  ...
  @PAD-2928_TC150_AndroidTorFxMob @regression
  ...
  Scenario Outline: 3.16 To verify invalid OTP error message on add recipient otp screen
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam William   | United Kingdom-GBP |      12345678 |    111111 | AndroidInvlaidOTP | 
  ...
  Scenario Outline: 3.17,3.18 To verify recipient should be add successfully and newly added recipient should be mapped correctly on recipient view screen.
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | shorn Walness | United Kingdom-EUR | GB29NWBK60161331926819 | 
  ...
  Scenario Outline: 3.7,3.8,3.9 To verify error message while adding duplicate payee
    ...
    Examples: 
      | emailAddress | password       | Type       | recipientName | country-currency | accountNumber      | 
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Adam Kelvin   | Finland-EUR      | FI2112345600000785 | 
  ...
  Scenario Outline: 1.2.2 To verify when user selects the country for which default currency is (not available online) then select currency gets displayed where user can selects the currency manually.
   ...
   Then android the app should load the onboarding screen
    ...
    Examples: 
      | emailAddress    | password          | Type       | recipientName | country-currency             | accountNumber | swiftCode | 
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam Walness   | United States of America-USD |      22345678 | 122235821 | 
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam Walness   | South Africa-ZAR             |      22345678 | 200309    |
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam Walness   | New Zealand-NZD              |      22345678 | 010001    |
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam Walness   | Australia-AUD                |      22345678 | 512170    |
    ...
    Examples: 
       | emailAddress    | password          | Type       | recipientName | country-currency  | validIBAN                   | 
       | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam William   | Spain-EUR         | ES9121000418450200051332    | 
       | TorFxRegEmailId | TorFxRegEmailPass | Company    | Sam William   | France-EUR        | FR1420041010050500013M02606 | 
    ...
    Examples: 
      | emailAddress    | password          | Type       | recipientName | country-currency   |accountNumber| validsortcode | 
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam William   | United Kingdom-GBP | 12345689    |       401527  |   
    ...
    Examples: 
      | emailAddress    | password          | Type       | recipientName | country-currency   |accountNumber| swiftCode      | 
      | TorFxRegEmailId | TorFxRegEmailPass | Company    | Sam William   | India-INR          | 12345689125 |  SBIN0001537   |   
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam William   | Singapore-SGD      | 12345687989 |     DBSSSGSG   |
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam William   | China-HKD          | 12345687989 | 501100000011   |
    ...
    Examples: 
      | emailAddress    | password          | Type       | recipientName | country-currency | accountNumber | swiftCode | State  |
      | TorFxRegEmailId | TorFxRegEmailPass | Individual | Sam Walness   | CANADA-CAD       |      22345678 | 026011242 | abcd   |
