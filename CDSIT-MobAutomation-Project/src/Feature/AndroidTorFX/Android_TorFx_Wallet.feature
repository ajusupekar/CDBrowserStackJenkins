...
Feature: Wallet 
   ...
   # When android user click on wallet currency "<currency>" from wallet screen page
    ...
    @PAD-3395_TC19_AndroidMobTorFx @TorFxSanity @regression  
    ...
    @PAD-3395_20_AndroidMobTorFx @TorFxSanity @regression 
   ...
   Then android the app should load the onboarding screen
    ...
    @PAD-3396_TC40_AndroidMobTorFx @TorFxSanity @regression 
   ...
   Examples:
    ...
    @PAD-3398_TC65_AndroidMobTorFx @TorFxSanity @regression 
    ...
    Examples:
     ...
     @PAD-3399_TC66_AndroidMobTorFx @TorFxSanity @regression 
    ...
    @PAD-3396_TC68_AndroidMobTorFx @TorFxSanity @regression 
   ...
   Examples:
    ...
    @PAD-3392_TC88_AndroidMobTorFx @TorFxSanity @regression 
