...
Feature: To test the registration functionality
  ...
  @CD_PID-3854_TC07 @Regression(1) @CDRegLot1
  ...
  @CD_PID-3854_TC09 @CD_Regression(1) @CDRegLot1
  ...
  @CD_PID-3854_TC15 @CD_Regression(1) @CDRegLot1
  ...
  @CD_PID-3858_42 @Regression(1) @CDRegLot4
  ...
  @CD_PID-3858_43 @Regression(1) @CDRegLot5
  ...
  Scenario Outline: 7.2 To verify the all parameters of set Password screen when user landed on set password screen
    ...
    Examples: 
      | FirstName | LastName | EmailID                       | DateOfBirth | country | occupation | otherOccupation | address | countryCode | mobileNumber | environment | password  |
      | Andrew    | Thompson | jake_sithd720@dispostable.com | 12-03-1987  | France  | Director   | NA              |   33500 | +91         |   8788836324 | UAT         | Welcome12 |

  @CD_PID-3856_59 @CDRegLot5
  Scenario Outline: 7.11,7.12 To verify that continue button when user selects the T&Cs acknowledgment switch
    ...
    Examples: 
      | FirstName | LastName | EmailID                       | DateOfBirth | country | occupation | otherOccupation | address | countryCode | mobileNumber | environment | password  |
      | Andrew    | Thompson | jake_sitbd720@dispostable.com | 12-03-1987  | France  | Director   | NA              |   33500 | +91         |   8788836324 | UAT         | Welcome12 |

  @CD_PID-3856_60 @CDRegLot5
  Scenario Outline: To verify that continue button remains disabled when user do not enters Password or accepts T&Cs
    ...
    Examples: 
      | FirstName | LastName | EmailID                       | DateOfBirth | country | occupation | otherOccupation | address | countryCode | mobileNumber | environment | password  |
      | Andrew    | Thompson | jake_sitbd820@dispostable.com | 12-03-1987  | France  | Director   | NA              |   33500 | +91         |   8788836324 | UAT         | Welcome12 |
  ...
  @CD_PID-3856_61 @CD_Regression(1)
  Scenario Outline: 8.2 To verify success page for STP user
    ...
    Examples: 
      ...
      | hr6       | okb6     | ngd75564@dispostable.com | 12-03-1987  | Australia | Director   | NA              | AUSAdd  | 1234567890 |   8788836324 | UAT         | Welcome12 | +91         |

  @CD_PID-3859_4 @CD_Sanity @CDRegLot5
  Scenario Outline: 7.14 To verify that user land on kyc screen for UK country
    ...
    Examples: 
      | FirstName | LastName  | EmailID                   | DateOfBirth | country        | occupation | otherOccupation | address | countryCode | mobileNumber | environment | password  |
      | armins  | leits50 | Armes866@dispostable.com | 11-03-1987  | United Kingdom | Director   | NA              |   33500 | +91         |   8149461195 | UAT         | Welcome12 |
